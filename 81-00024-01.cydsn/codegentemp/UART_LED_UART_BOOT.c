/*******************************************************************************
* File Name: UART_LED_UART_BOOT.c
* Version 3.10
*
* Description:
...
/*******************************************************************************
* Function Name: UART_LED_UartCyBtldrCommStart
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: UART_LED_UartCyBtldrCommStop
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: UART_LED_UartCyBtldrCommReset
********************************************************************************
*
* Summary:
...
void UART_LED_UartCyBtldrCommReset(void)
{
    ...
    UART_LED_SpiUartClearRxBuffer();
    UART_LED_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: UART_LED_UartCyBtldrCommRead
********************************************************************************
*
* Summary:
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != UART_LED_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = UART_LED_SpiUartGetRxBufferSize();
                    CyDelayUs(UART_LED_UART_BYTE_TO_BYTE);
                }
                while (byteCount != UART_LED_SpiUartGetRxBufferSize());

                byteCount = UART_LED_BYTES_TO_COPY(byteCount, size);
        ...
        {
            pData[i] = (uint8) UART_LED_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: UART_LED_UartCyBtldrCommWrite
********************************************************************************
*
* Summary:
...
cystatus UART_LED_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        UART_LED_SpiUartPutArray(pData, (uint32) size);
