...
module ADC_SAR_SEQ_P4_v2_50_5 (
	...
	cy_clock_v1_0
		#(.id("e77519f6-6b24-490a-ad15-94c44af1b63a/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("218764000.896057"),
		  .is_direct(0),
		  .is_digital(0))
		intClock
		 (.clock_out(Net_1845));
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=300, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=SamplingTimer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SamplingTimer, CY_INSTANCE_SHORT_NAME=SamplingTimer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=SamplingTimer, )
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=1000, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=1000, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=1000, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=2000, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=AckTimer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=AckTimer, CY_INSTANCE_SHORT_NAME=AckTimer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=AckTimer, )
...
`ifdef WARP
`define CY_BLK_DIR "C:\Users\kylep\My Documents\PSoC Creator\4.1\Downloads ( 4.1).cylib\B_Timer_v2_80"
...
module top ;
	...
	wire [0:0] tmpOE__HBridge_CS_net;
	wire [0:0] tmpFB_0__HBridge_CS_net;
	wire [0:0] tmpIO_0__HBridge_CS_net;
	wire [0:0] tmpINTERRUPT_0__HBridge_CS_net;
	electrical [0:0] tmpSIOVREF__HBridge_CS_net;

	cy_psoc3_pins_v1_10
		#(.id("7653b4d4-c3a6-48d8-b939-ecd40a2e607e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		HBridge_CS
		 (.oe(tmpOE__HBridge_CS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HBridge_CS_net[0:0]}),
		  .analog({Net_3531}),
		  .io({tmpIO_0__HBridge_CS_net[0:0]}),
		  .siovref(tmpSIOVREF__HBridge_CS_net),
		  .interrupt({tmpINTERRUPT_0__HBridge_CS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HBridge_CS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SwitchNodeTempInput_net;
	wire [0:0] tmpFB_0__SwitchNodeTempInput_net;
	wire [0:0] tmpIO_0__SwitchNodeTempInput_net;
	wire [0:0] tmpINTERRUPT_0__SwitchNodeTempInput_net;
	electrical [0:0] tmpSIOVREF__SwitchNodeTempInput_net;

	cy_psoc3_pins_v1_10
		#(.id("922b5129-20f9-453f-b7c6-2b0c40c8779c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SwitchNodeTempInput
		 (.oe(tmpOE__SwitchNodeTempInput_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SwitchNodeTempInput_net[0:0]}),
		  .analog({Net_765}),
		  .io({tmpIO_0__SwitchNodeTempInput_net[0:0]}),
		  .siovref(tmpSIOVREF__SwitchNodeTempInput_net),
		  .interrupt({tmpINTERRUPT_0__SwitchNodeTempInput_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SwitchNodeTempInput_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 PWM_Enable (
        .control_1(Net_3463),
        .control_2(Net_3464),
        .control_3(Net_3465),
        .control_0(Net_127),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam PWM_Enable.Bit0Mode = 0;
    defparam PWM_Enable.Bit1Mode = 0;
    defparam PWM_Enable.Bit2Mode = 0;
    defparam PWM_Enable.Bit3Mode = 0;
    defparam PWM_Enable.Bit4Mode = 0;
    defparam PWM_Enable.Bit5Mode = 0;
    defparam PWM_Enable.Bit6Mode = 0;
    defparam PWM_Enable.Bit7Mode = 0;
    defparam PWM_Enable.BitValue = 0;
    defparam PWM_Enable.BusDisplay = 0;
    defparam PWM_Enable.ExtrReset = 0;
    defparam PWM_Enable.NumOutputs = 1;

    assign Net_3472 = 1'h0;

	wire [0:0] tmpOE__HBridge_INB_net;
	wire [0:0] tmpFB_0__HBridge_INB_net;
	wire [0:0] tmpIO_0__HBridge_INB_net;
	wire [0:0] tmpINTERRUPT_0__HBridge_INB_net;
	electrical [0:0] tmpSIOVREF__HBridge_INB_net;

	cy_psoc3_pins_v1_10
		#(.id("9dbb4c31-7ff0-4e04-b0ac-1f14d10097ed"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		HBridge_INB
		 (.oe(tmpOE__HBridge_INB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HBridge_INB_net[0:0]}),
		  .io({tmpIO_0__HBridge_INB_net[0:0]}),
		  .siovref(tmpSIOVREF__HBridge_INB_net),
		  .interrupt({tmpINTERRUPT_0__HBridge_INB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HBridge_INB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HBridge_PWM_net;
	wire [0:0] tmpFB_0__HBridge_PWM_net;
	wire [0:0] tmpIO_0__HBridge_PWM_net;
	wire [0:0] tmpINTERRUPT_0__HBridge_PWM_net;
	electrical [0:0] tmpSIOVREF__HBridge_PWM_net;

	cy_psoc3_pins_v1_10
		#(.id("e139a788-98d5-45ba-ba7e-3e59f5225765"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		HBridge_PWM
		 (.oe(tmpOE__HBridge_PWM_net),
		  .y({Net_2173}),
		  .fb({tmpFB_0__HBridge_PWM_net[0:0]}),
		  .io({tmpIO_0__HBridge_PWM_net[0:0]}),
		  .siovref(tmpSIOVREF__HBridge_PWM_net),
		  .interrupt({tmpINTERRUPT_0__HBridge_PWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HBridge_PWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HBridge_INA_net;
	wire [0:0] tmpFB_0__HBridge_INA_net;
	wire [0:0] tmpIO_0__HBridge_INA_net;
	wire [0:0] tmpINTERRUPT_0__HBridge_INA_net;
	electrical [0:0] tmpSIOVREF__HBridge_INA_net;

	cy_psoc3_pins_v1_10
		#(.id("f7b11513-ed5b-4171-8548-4ba3a45852fb"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		HBridge_INA
		 (.oe(tmpOE__HBridge_INA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HBridge_INA_net[0:0]}),
		  .io({tmpIO_0__HBridge_INA_net[0:0]}),
		  .siovref(tmpSIOVREF__HBridge_INA_net),
		  .interrupt({tmpINTERRUPT_0__HBridge_INA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HBridge_INA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_0 motorControlPWM (
        .reset(Net_2840),
        .clock(Net_481),
        .tc(Net_2853),
        .pwm1(Net_2854),
        ...
        .ph1(Net_2862),
        .ph2(Net_2863));
    defparam motorControlPWM.Resolution = 8;
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_3472 or Net_691 or Net_127)
        begin
            case (Net_127)
                1'b0 :  tmp__mux_2_reg = Net_3472;
                1'b1 :  tmp__mux_2_reg = Net_691;
            endcase
        end
        assign Net_3450 = tmp__mux_2_reg;
    end
    // -- Mux end --

    TCPWM_P4_v2_10_2 TimeoutTimer (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("a1ce8de6-3665-42ca-9c03-d97051056893"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("ed5d2b97-ff6f-4137-bacd-1f7f614c5c55"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("19607843137.2549"),
		  .is_direct(0),
		  .is_digital(1))
		Clock_2
		 (.clock_out(Net_1983));
	...
	wire [0:0] tmpOE__LED_TempInput_net;
	wire [0:0] tmpFB_0__LED_TempInput_net;
	wire [0:0] tmpIO_0__LED_TempInput_net;
	wire [0:0] tmpINTERRUPT_0__LED_TempInput_net;
	electrical [0:0] tmpSIOVREF__LED_TempInput_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_TempInput
		 (.oe(tmpOE__LED_TempInput_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_TempInput_net[0:0]}),
		  .analog({Net_3544}),
		  .io({tmpIO_0__LED_TempInput_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_TempInput_net),
		  .interrupt({tmpINTERRUPT_0__LED_TempInput_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_TempInput_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_SEQ_P4_v2_50_5 ADC_SAR_Seq (
        .Vref(Net_4291),
        .sdone(Net_4292),
        .eoc(Net_4293),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__LED_Output_net;
	wire [0:0] tmpFB_0__LED_Output_net;
	wire [0:0] tmpIO_0__LED_Output_net;
	wire [0:0] tmpINTERRUPT_0__LED_Output_net;
	electrical [0:0] tmpSIOVREF__LED_Output_net;

	cy_psoc3_pins_v1_10
		#(.id("4a54f08e-556f-4985-ac4c-54a8834371f3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_Output
		 (.oe(tmpOE__LED_Output_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_Output_net[0:0]}),
		  .io({tmpIO_0__LED_Output_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Output_net),
		  .interrupt({tmpINTERRUPT_0__LED_Output_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_Output_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("f3f69efa-80e2-4fa9-bd0f-45f9336b46a8"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__PotFeedBack_net;
	wire [0:0] tmpFB_0__PotFeedBack_net;
	wire [0:0] tmpIO_0__PotFeedBack_net;
	wire [0:0] tmpINTERRUPT_0__PotFeedBack_net;
	electrical [0:0] tmpSIOVREF__PotFeedBack_net;

	cy_psoc3_pins_v1_10
		#(.id("f1ba5a01-55d4-4070-96ba-779bf05803ea"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PotFeedBack
		 (.oe(tmpOE__PotFeedBack_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PotFeedBack_net[0:0]}),
		  .analog({Net_3549}),
		  .io({tmpIO_0__PotFeedBack_net[0:0]}),
		  .siovref(tmpSIOVREF__PotFeedBack_net),
		  .interrupt({tmpINTERRUPT_0__PotFeedBack_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PotFeedBack_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_6 SamplingTimer (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("f8d74e70-c36e-42fd-a2f1-0410ecbd95ba"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__DIM_PLUS_net;
	wire [0:0] tmpIO_0__DIM_PLUS_net;
	wire [0:0] tmpINTERRUPT_0__DIM_PLUS_net;
	electrical [0:0] tmpSIOVREF__DIM_PLUS_net;

	cy_psoc3_pins_v1_10
		#(.id("cfa916e2-3678-499e-8466-fce09ac23c23"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DIM_PLUS
		 (.oe(tmpOE__DIM_PLUS_net),
		  .y({1'b0}),
		  .fb({Net_3327[2]}),
		  .io({tmpIO_0__DIM_PLUS_net[0:0]}),
		  .siovref(tmpSIOVREF__DIM_PLUS_net),
		  .interrupt({tmpINTERRUPT_0__DIM_PLUS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIM_PLUS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("b66e55a9-26f0-4da1-83d8-5d6724aa2904"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("195312500"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__limitSwitch_net;
	wire [0:0] tmpFB_0__limitSwitch_net;
	wire [0:0] tmpIO_0__limitSwitch_net;
	electrical [0:0] tmpSIOVREF__limitSwitch_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		limitSwitch
		 (.oe(tmpOE__limitSwitch_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__limitSwitch_net[0:0]}),
		  .io({tmpIO_0__limitSwitch_net[0:0]}),
		  .siovref(tmpSIOVREF__limitSwitch_net),
		  .interrupt({Net_1594}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__limitSwitch_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_9 overCurrentTimer (
        .reset(Net_12),
        .interrupt(Net_3294),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_3298),
        .tc(Net_6713),
        .clock(Net_3276));
    defparam overCurrentTimer.CaptureCount = 2;
    defparam overCurrentTimer.CaptureCounterEnabled = 0;
	...
	wire [0:0] tmpOE__ZOOM_MINUS_net;
	wire [0:0] tmpIO_0__ZOOM_MINUS_net;
	wire [0:0] tmpINTERRUPT_0__ZOOM_MINUS_net;
	electrical [0:0] tmpSIOVREF__ZOOM_MINUS_net;

	cy_psoc3_pins_v1_10
		#(.id("133be337-9f48-4fbf-9b76-bc7c927f198f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ZOOM_MINUS
		 (.oe(tmpOE__ZOOM_MINUS_net),
		  .y({1'b0}),
		  .fb({Net_3327[3]}),
		  .io({tmpIO_0__ZOOM_MINUS_net[0:0]}),
		  .siovref(tmpSIOVREF__ZOOM_MINUS_net),
		  .interrupt({tmpINTERRUPT_0__ZOOM_MINUS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ZOOM_MINUS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyStatusReg_v1_90 inputs (
        ...
        .intr(Net_3626),
        .status_bus(8'b0));
    defparam inputs.Bit0Mode = 0;
    defparam inputs.Bit1Mode = 0;
    defparam inputs.Bit2Mode = 0;
    defparam inputs.Bit3Mode = 0;
    defparam inputs.Bit4Mode = 0;
    defparam inputs.Bit5Mode = 0;
    defparam inputs.Bit6Mode = 0;
    defparam inputs.Bit7Mode = 0;
    defparam inputs.BusDisplay = 0;
    defparam inputs.Interrupt = 0;
    defparam inputs.MaskValue = 0;
    defparam inputs.NumInputs = 4;
	...
	wire [0:0] tmpOE__ZOOM_PLUS_net;
	wire [0:0] tmpIO_0__ZOOM_PLUS_net;
	wire [0:0] tmpINTERRUPT_0__ZOOM_PLUS_net;
	electrical [0:0] tmpSIOVREF__ZOOM_PLUS_net;

	cy_psoc3_pins_v1_10
		#(.id("cd577efb-3e27-4c54-9664-20ab99d648f7"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ZOOM_PLUS
		 (.oe(tmpOE__ZOOM_PLUS_net),
		  .y({1'b0}),
		  .fb({Net_3327[1]}),
		  .io({tmpIO_0__ZOOM_PLUS_net[0:0]}),
		  .siovref(tmpSIOVREF__ZOOM_PLUS_net),
		  .interrupt({tmpINTERRUPT_0__ZOOM_PLUS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ZOOM_PLUS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_3629 = Net_3388[3] | Net_3388[2] | Net_3388[1] | Net_3388[0];

	wire [0:0] tmpOE__DIM_MINUS_net;
	wire [0:0] tmpIO_0__DIM_MINUS_net;
	wire [0:0] tmpINTERRUPT_0__DIM_MINUS_net;
	electrical [0:0] tmpSIOVREF__DIM_MINUS_net;

	cy_psoc3_pins_v1_10
		#(.id("5348933a-bb79-4800-b64f-c22d83fe60ee"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DIM_MINUS
		 (.oe(tmpOE__DIM_MINUS_net),
		  .y({1'b0}),
		  .fb({Net_3327[0]}),
		  .io({tmpIO_0__DIM_MINUS_net[0:0]}),
		  .siovref(tmpSIOVREF__DIM_MINUS_net),
		  .interrupt({tmpINTERRUPT_0__DIM_MINUS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIM_MINUS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
