/*******************************************************************************
* File Name: UART_Out_UART_BOOT.c
* Version 3.10
*
* Description:
...
/*******************************************************************************
* Function Name: UART_Out_UartCyBtldrCommStart
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: UART_Out_UartCyBtldrCommStop
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: UART_Out_UartCyBtldrCommReset
********************************************************************************
*
* Summary:
...
void UART_Out_UartCyBtldrCommReset(void)
{
    ...
    UART_Out_SpiUartClearRxBuffer();
    UART_Out_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: UART_Out_UartCyBtldrCommRead
********************************************************************************
*
* Summary:
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != UART_Out_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = UART_Out_SpiUartGetRxBufferSize();
                    CyDelayUs(UART_Out_UART_BYTE_TO_BYTE);
                }
                while (byteCount != UART_Out_SpiUartGetRxBufferSize());

                byteCount = UART_Out_BYTES_TO_COPY(byteCount, size);
        ...
        {
            pData[i] = (uint8) UART_Out_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: UART_Out_UartCyBtldrCommWrite
********************************************************************************
*
* Summary:
...
cystatus UART_Out_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        UART_Out_SpiUartPutArray(pData, (uint32) size);
