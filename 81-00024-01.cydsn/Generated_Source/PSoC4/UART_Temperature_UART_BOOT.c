/*******************************************************************************
* File Name: UART_Temperature_UART_BOOT.c
* Version 3.10
*
* Description:
...
/*******************************************************************************
* Function Name: UART_Temperature_UartCyBtldrCommStart
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: UART_Temperature_UartCyBtldrCommStop
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: UART_Temperature_UartCyBtldrCommReset
********************************************************************************
*
* Summary:
...
void UART_Temperature_UartCyBtldrCommReset(void)
{
    ...
    UART_Temperature_SpiUartClearRxBuffer();
    UART_Temperature_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: UART_Temperature_UartCyBtldrCommRead
********************************************************************************
*
* Summary:
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != UART_Temperature_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = UART_Temperature_SpiUartGetRxBufferSize();
                    CyDelayUs(UART_Temperature_UART_BYTE_TO_BYTE);
                }
                while (byteCount != UART_Temperature_SpiUartGetRxBufferSize());

                byteCount = UART_Temperature_BYTES_TO_COPY(byteCount, size);
            ...
            CyDelay(UART_Temperature_WAIT_1_MS);
            --timeoutMs;
        }
        while (0u != timeoutMs);
        ...
        {
            pData[i] = (uint8) UART_Temperature_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: UART_Temperature_UartCyBtldrCommWrite
********************************************************************************
*
* Summary:
...
cystatus UART_Temperature_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        UART_Temperature_SpiUartPutArray(pData, (uint32) size);
