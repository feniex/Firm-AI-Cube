...
/*******************************************************************************
* Function Name: UART_FF_UartCyBtldrCommStart
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: UART_FF_UartCyBtldrCommStop
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: UART_FF_UartCyBtldrCommReset
********************************************************************************
*
* Summary:
...
void UART_FF_UartCyBtldrCommReset(void)
{
    ...
    UART_FF_SpiUartClearRxBuffer();
    UART_FF_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: UART_FF_UartCyBtldrCommRead
********************************************************************************
*
* Summary:
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != UART_FF_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = UART_FF_SpiUartGetRxBufferSize();
                    CyDelayUs(UART_FF_UART_BYTE_TO_BYTE);
                }
                while (byteCount != UART_FF_SpiUartGetRxBufferSize());

                byteCount = UART_FF_BYTES_TO_COPY(byteCount, size);
        ...
        {
            pData[i] = (uint8) UART_FF_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: UART_FF_UartCyBtldrCommWrite
********************************************************************************
*
* Summary:
...
cystatus UART_FF_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        UART_FF_SpiUartPutArray(pData, (uint32) size);
