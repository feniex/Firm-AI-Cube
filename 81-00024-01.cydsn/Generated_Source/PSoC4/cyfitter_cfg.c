...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT08), 0x00000012u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT09), 0x00000022u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT10), 0x00000013u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT11), 0x00000031u);
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B02), 0x8000002Fu);

	/* CYDEV_CLK_DIVIDER_C02 Starting address: CYDEV_CLK_DIVIDER_C02 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C02), 0x800003ACu);
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_FRAC_B00), 0x8000063Fu);

	/* CYDEV_CLK_DIVIDER_FRAC_C00 Starting address: CYDEV_CLK_DIVIDER_FRAC_C00 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_FRAC_C00), 0xC00005DBu);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F4012u, /* Base address: 0x400F4000 Count: 18 */
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x00C80000u);
